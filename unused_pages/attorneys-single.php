...
<!-- Mirrored from html.efforttech.com/html/supremelaw/attorneys-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Jan 2023 22:52:25 GMT -->
<head>
<meta charset="utf-8">
<title>Supreme Law HTML Template | Attorneys Single</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
            	...
            	<div class="clearfix">
                    ...
                    <div class="pull-right upper-right clearfix">
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
                            	<li><strong>info@domain.com</strong></li>
                        ...
                        <div class="upper-column info-box">
                            ...
                            <ul>
                            	<li><strong>+92 354 5386 24</strong></li>
                                <li>5648 VK 26th Lane - Florida 26154.</li>
                            </ul>
                        </div>
            	...
            	<div class="nav-outer clearfix">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown"><a href="#">Practice Areas</a>
                                    <ul>
                                        <li><a href="practice.html">All Practices</a></li>
                                        <li><a href="practice-single.html">Family Law</a></li>
                                        <li><a href="practice-single.html">Business Law</a></li>
                                        <li><a href="practice-single.html">Criminal Law</a></li>
                                        <li><a href="practice-single.html">Insurance Law</a></li>
                                        <li><a href="practice-single.html">Drug Control Law</a></li>
                                        <li><a href="practice-single.html">Consumer Law</a></li>
                                    </ul>
                                </li>
                                <li class="current dropdown"><a href="#">Attorneys</a>
                                    <ul>
                    ...
                    <div class="outer-box clearfix">
                                ...
                                <ul class="dropdown-menu pull-right search-panel" aria-labelledby="dropdownMenu3">
                                    <li class="panel-outer">
                                        <div class="form-container">
                                            <form method="post" action="https://html.efforttech.com/html/supremelaw/blog.html">
                        ...
                        <div class="advisor-box">
                        	<a href="#" class="theme-btn advisor-btn">Free Consultation</a>
                        </div>
    ...
    <section class="page-title" style="background-image:url(images/background/9.jpg)">
    	<div class="auto-container">
        	<h1>Attorneys Portfolio</h1>
            <ul class="page-breadcrumb">
            	<li>You are here:</li>
            	<li><a href="index-2.html">  Home</a></li>
                <li>Attorneys Portfolio</li>
            </ul>
        </div>
    </section>
    <!--End Page Title-->
    ...
    <section class="attorneys-single-section">
    	<div class="auto-container">
        	<div class="row clearfix">
                ...
                <div class="info-column col-md-4 col-sm-12 col-xs-12">
                	<div class="inner-column">
                        ...
                        <h2>Mercy Van Desosa</h2>
                        <div class="designation">Consumer Lawyer</div>
                        <div class="text">Bank And Financial   /   Capital Market</div>
                        <ul>
                        	<li>Phone:<span>97877-32-100</span></li>
                            <li>Email:<span>Jemstone@domain.com</span></li>
                            <li>Follow us: <a href="#" class="fa fa-facebook"></a> <a href="#" class="fa fa-twitter"></a><a href="#" class="fa fa-google-plus"></a><a href="#" class="fa fa-dribbble"></a><a href="#" class="fa fa-pinterest-p"></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="content-column col-md-8 col-sm-12 col-xs-12">
                	<div class="inner-column">
                    	<h2>My <span class="theme_color">Objective</span></h2>
                        <div class="text">
                            ...
                            <h3>About <span class="theme_color">Education</span></h3>
                            <ul class="attorneys-info">
                            ...
                            <h3>Bar <span class="theme_color">Admissions</span></h3>
                            <ul class="attorneys-info">
                            ...
                            <h3>Court <span class="theme_color">Admissions</span></h3>
                            <ul class="attorneys-info">
                            	<li><strong>UK Supreme Court -</strong> There are many variations of passages of Lorem Ipsum available ut, but the majority have suffered alteration in some form by injected humour, or randomised words which don't look even the slightly believable if you are going to use a passage of Lorem Ipsums, you need in the middle the UK Supreme Court.</li>
                            </ul>
                            <h3>Professional  <span class="theme_color">Affiliations</span></h3>
                            ...
                            <h3>Honors <span class="theme_color">and Awards</span></h3>
    ...
    <!--End Attorneys Single Section-->
    
    <!--Consulting Section-->
    <section class="consulting-section style-two" style="background-image:url(images/background/3.jpg)">
    	<div class="auto-container">
            ...
            <div class="default-form">
                <!--Call Back Form-->
                <form method="post" action="https://html.efforttech.com/html/supremelaw/contact.html">
                    <div class="row clearfix">
                        ...
                        <div class="form-group text-center col-md-12 col-sm-12 col-xs-12">
                            <button class="theme-btn submit-btn" type="submit" name="submit-form">Free Consultation</button>
                        </div>
                ...
                <div class="column col-md-4 col-sm-6 col-xs-12">
                	...
                	<div class="info-block">
                    	<div class="block-inner">
                            ...
                            <div class="text">5648, VK 26th Lane Sparks Steet, Opp Joe Park-Florida 26154.</div>
                        </div>
                    </div>
                ...
                <div class="column col-md-4 col-sm-6 col-xs-12">
                	...
                	<div class="info-block">
                    	<div class="block-inner">
                            ...
                            <div class="text">+123 859 625, +321 569 742 <br> Lawyerjustice@example.com</div>
                        </div>
                    </div>
                ...
                <div class="column col-md-4 col-sm-6 col-xs-12">
                	...
                	<div class="info-block">
                    	<div class="block-inner">
                            ...
                            <div class="text">Monday-Satday: 09.00am to 15.00pm Sunday Holiday</div>
                        </div>
                    </div>
    ...
    <footer class="main-footer style-two" style="background-image:url(images/background/5.jpg)">
		<div class="auto-container">
            	...
            	<div class="row clearfix">
                    ...
                    <div class="footer-column col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget logo-widget">
                            ...
                            <div class="text">
                            	<p>Since 1965, who loves or pursues seds or ut desires too obtains Attorneys of itself sed, will ut because it is pain, but because occasionally labor uts lawyer Supreme Law occurs.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer-widget news-widget">
                            ...
                            <div class="news-widget-block">
                            	<div class="widget-inner">
                                	<div class="image">
                                    	<img src="images/resource/news-icon-1.jpg" alt="" />
                                    </div>
                                    <h3><a href="blog-detail.html">We won against criminal</a></h3>
                                    <div class="post-date">20 May 2018</div>
                                </div>
                            </div>
                            ...
                            <div class="news-widget-block">
                            	<div class="widget-inner">
                                	<div class="image">
                                    	<img src="images/resource/news-icon-2.jpg" alt="" />
                                    </div>
                                    <h3><a href="blog-detail.html">Legal issues regarding paternity</a></h3>
                                    <div class="post-date">20 May 2018</div>
                                </div>
                            </div>
            ...
            <div class="footer-bottom">
            	...
            	<div class="copyright">&copy; 2018 Eminent All rights reserved. by <a href="#">Yogsthemes</a></div>
            </div>
