                ...
                <div class="practice-single">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h2>About <span class="theme_color">Criminal Law</span></h2>
                            <div class="text">
                                <p>At <?php echo $name; ?>, litigation services include personal injury, employment,
                                    commercial, builders’ liens, and debt collection. We advocate for our clients,
                                    seeking a fair resolution within a reasonable timeframe and without huge expense.
                                    Where appropriate, we encourage our clients to consider settlement or alternative
                                    dispute resolution mechanisms, such as mediation or arbitration.</p>
                                <h3>Know Your <span class="theme_color">Rights</span></h3>
                                <p>The Firm has successfully represented clients in some very challenging litigation and
                                    dispute resolution matters involving complex issues of law. Our approach is
                                    solution-oriented and emphasizes on a practical understanding of our clients'
                                    business problems to find a legal solution to address them.</p>
