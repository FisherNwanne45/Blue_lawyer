                ...
                <aside class="sidebar default-sidebar">
                    ...
                    <div class="sidebar-widget sidebar-blog-category">
                        <ul class="blog-cat">
                            ...
                            <li class="active"><a href="family.php"><span class="icon flaticon-family"></span> Family
                                    Law</a></li>
                ...
                <div class="practice-single">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h2>About <span class="theme_color">Family Law</span></h2>
                            <div class="text">
                                <p>Family law consists of a body of statutes and case precedentss that govern the legal
                                    responsibilities between individuals who share a domestic connection. These cases
                                    usually involve parties who are related by blood or marriage, but family law can
                                    affect those in more distant or casual relationships as well. Due to the
                                    emotionally-charged nature of moost family law cases, litigants are strongly advised
                                    to retain legal counsel</p>
                                <h3>Know Your <span class="theme_color">Rights</span></h3>
                                <p>Responsibilities betweens individuals who share a domestic connection. These cases
                                    usually involves parties who are related by blood or marriage, but famiily law can
                                    affect those in more distant or casuals relationships.</p>
                                            ...
                                            <ul class="accordion-box style-two">
                                                ...
                                                <li class="accordion block">
                                                    <div class="acc-btn">
                                                        <div class="icon-outer"><span
                                                                class="icon icon-plus fa fa-angle-right"></span></div>
                                                        Creating a Prenuptial Agreement
                                                    </div>
                                                    <div class="acc-content">
                                                        <div class="content">
                                                            <div class="text">It is easy to become wrapped up in the
                                                                excitement of love and a weddiing and to forget about
                                                                what exactly could be should things go wrong.</div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="accordion block active-block">
                                                    ...
                                                    <div class="acc-content current">
                                                        <div class="content">
                                                            <div class="text">It is easy to become wrapped up in the
                                                                excitement of love and a wedding and to forget about
                                                                what exactly could be should things go wrong.</div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="accordion block">
                                                    ...
                                                    <div class="acc-content">
                                                        <div class="content">
                                                            <div class="text">It is easy to become wrapped up in the
                                                                excitement of loove and a wedding and to forget about
                                                                what exactly could be should things go wrong.</div>
                                                        </div>
                                                    </div>
                                                </li>
